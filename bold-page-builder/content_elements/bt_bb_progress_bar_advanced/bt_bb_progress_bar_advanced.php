...
class bt_bb_progress_bar_advanced extends BT_BB_Element {
		...
		*/
		...
		if ( $link != '' ) {
			...
			$output .= '<div' . $id_attr . ' class="' . esc_attr( implode( ' ', $class ) ) . '"' . $style_attr . ' ' . $data . '>';		
				$output .= '<div id="' . esc_attr( 'container_' . $pb_id ) . '" class="container"></div>';
				if ( $container_text != '' ) {
	...
	function map_shortcode() {
		...
		bt_bb_map( $this->shortcode, array( 'name' => esc_html__( 'Advanced Progress bar', 'prohauz' ), 'description' => esc_html__( 'Advanced Progress bar', 'prohauz' ), 'container' => 'vertical', 'accept' => false, 'icon' => $this->prefix_backend . 'icon' . '_' . $this->shortcode,
			'params' => array(
				array( 'param_name' => 'type', 'type' => 'dropdown', 'heading' => esc_html__( 'Progress Bar Type', 'prohauz' ), 'preview' => true,
					'value' => array(
						esc_html__( 'Semi circle', 'prohauz' ) => 'semi-circle',
				...
				array( 'param_name' => 'duration', 'type' => 'textfield', 'heading' => esc_html__( 'Animation duration', 'prohauz' ), 'preview' => true ),
						array( 'param_name' => 'easing', 'type' => 'dropdown', 'heading' => esc_html__( 'Easing', 'prohauz' ), 'preview' => true,
					'value' => array(
						esc_html__( 'Linear', 'prohauz' ) => 'linear',
						esc_html__( 'Ease In Out', 'prohauz' ) => 'easeInOut',
						esc_html__( 'Bounce', 'prohauz' ) => 'bounce'
					)
				),
				array( 'param_name' => 'text', 'type' => 'textfield', 'heading' => esc_html__( 'Text below the icon or percentage', 'prohauz' ), 'preview' => true ),				
				...
				array( 'param_name' => 'target', 'type' => 'dropdown', 'heading' => esc_html__( 'URL Target', 'prohauz' ),
					'value' => array(
				...
				array( 'param_name' => 'thickness', 'type' => 'dropdown', 'heading' => esc_html__( 'Progress bar thickness', 'prohauz' ), 'group' => esc_html__( 'Design', 'prohauz' ),
					'value' => array(
						esc_html__( 'Small', 'prohauz' ) => 'small',
						esc_html__( 'Normal', 'prohauz' ) => 'normal',
						esc_html__( 'Medium', 'prohauz' ) => 'medium',
				...
				array( 'param_name' => 'trail_thickness', 'type' => 'dropdown', 'heading' => esc_html__( 'Progress bar trail thickness', 'prohauz' ), 'group' => esc_html__( 'Design', 'prohauz' ),
					'value' => array(
						esc_html__( 'Same as progress bar', 'prohauz' ) => 'progressbar',
						esc_html__( 'Small', 'prohauz' ) => 'small',
						esc_html__( 'Normal', 'prohauz' ) => 'normal',
						esc_html__( 'Medium', 'prohauz' ) => 'medium',
						esc_html__( 'Large', 'prohauz' ) => 'large',
				...
				array( 'param_name' => 'color_from', 'type' => 'colorpicker', 'heading' => esc_html__( 'Starting Progress Bar Background color', 'prohauz' ), 'group' => esc_html__( 'Design', 'prohauz' ) ),
				array( 'param_name' => 'color_to', 'type' => 'colorpicker', 'heading' => esc_html__( 'Ending Progress Bar Background color', 'prohauz' ), 'group' => esc_html__( 'Design', 'prohauz' ) ),
				array( 'param_name' => 'text_color', 'type' => 'colorpicker', 'heading' => esc_html__( 'Text color', 'prohauz' ), 'group' => esc_html__( 'Design', 'prohauz' ) ),
				array( 'param_name' => 'trail_color', 'type' => 'colorpicker', 'heading' => esc_html__( 'Color for lighter trail stroke underneath the actual progress path', 'prohauz' ), 'group' => esc_html__( 'Design', 'prohauz' ) ),
				array( 'param_name' => 'fill_color', 'type' => 'colorpicker', 'heading' => esc_html__( 'Fill color', 'prohauz' ), 'group' => esc_html__( 'Design', 'prohauz' ) )
			)
		) );
	}
}
