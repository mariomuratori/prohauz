...
boldthemes_add_mb( array( 'id' => 'page', 'title' => esc_html__( 'Settings', 'prohauz' ), 'post_type' => 'page', 'autosave' => true ) );
boldthemes_add_mb_field( 
	array(
		'mb_id'    => 'page',
		'field_id' => 'menu_name',
		'name'     => esc_html__( 'Custom Primary Menu Name', 'prohauz' ),
		'type'     => 'text'
	)
);
boldthemes_add_mb_field( 
	array(
		...
		'name'     => esc_html__( 'Custom Footer Menu Name', 'prohauz' ),
		'type'     => 'text'
	)
);
boldthemes_add_mb_field( 
	array(
		'mb_id'    => 'page',
		'field_id' => 'override',
		'name'     => esc_html__( 'Override Global Settings', 'prohauz' ),
		'type'     => 'boldthemestext',
		'clone'    => true
	)
);
...
boldthemes_add_mb( array( 'id' => 'post', 'title' => esc_html__( 'Settings', 'prohauz' ), 'post_type' => 'post', 'autosave' => true ) );
boldthemes_add_mb_field( 
	array(
		'mb_id'    => 'post',
		'field_id' => 'menu_name',
...
boldthemes_add_mb_field( 
	array(
		'mb_id'    => 'post',
		'field_id' => 'images',
		'name'     => esc_html__( 'Images', 'prohauz' ),
		'type'     => 'image_advanced'
	)
);
boldthemes_add_mb_field( 
	array(
		...
		'name'     => esc_html__( 'Grid Gallery', 'prohauz' ),
		'type'     => 'checkbox'
	)
);
boldthemes_add_mb_field( 
...
boldthemes_add_mb_field( 
	array(
		'mb_id'    => 'post',
		'field_id' => 'link_url',
		'name'     => esc_html__( 'Link URL', 'prohauz' ),
		'type'     => 'text'
	)
);
boldthemes_add_mb_field( 
...
boldthemes_add_mb_field( 
	array(
		...
		'name'     => esc_html__( 'Quote Author', 'prohauz' ),
		'type'     => 'text'
	)
);
...
boldthemes_add_mb( array( 'id' => 'portfolio', 'title' => esc_html__( 'Settings', 'prohauz' ), 'post_type' => 'portfolio', 'autosave' => true ) );
boldthemes_add_mb_field( 
	array(
		'mb_id'    => 'portfolio',
		'field_id' => 'images',
...
boldthemes_add_mb_field( 
	array(
		...
		'name'     => esc_html__( 'Custom Fields', 'prohauz' ),
...
boldthemes_add_mb( array( 'id' => 'product', 'title' => esc_html__( 'Settings', 'prohauz' ), 'post_type' => 'product', 'autosave' => true ) );
boldthemes_add_mb_field( 
	array(
		'mb_id'    => 'product',
		'field_id' => 'override',
